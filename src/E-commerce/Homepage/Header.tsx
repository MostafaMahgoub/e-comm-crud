...
function Header() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="relative" sx={{ height: '4vh' , backgroundColor: '#9C5BF5' , boxShadow : "none" }}>
      ...
      <AppBar position="relative" sx={{ height: '6vh' , backgroundColor: 'transparent' , boxShadow : "none" }}>
        <Toolbar sx={{ top: "2vh" ,margin: "0px 8vw"}}>
          ...
          <center style={{ flexGrow: 1 }}><Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1}}>
          <Tabs
           sx={{
             flexGrow: 1,
             display: 'flex',
           ...
           <Tab label="Blog" sx={{ ...tabStyles, color: "#DCFF02" }} />
           <Tab label="Pages" sx={{ ...tabStyles, color: "#DCFF02" }} />
         </Tabs>
         </Box>
         </center>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: "1vw" }}>
            <Button variant="contained" sx={{ bgcolor: '#FFFFFF', color: '#1C103B', fontFamily: 'Nunito' }}>
              <Typography variant="button" sx={{ display: 'flex', alignItems: 'center', gap: '5px', textTransform: 'none' , fontWeight: 'bold' }}>
